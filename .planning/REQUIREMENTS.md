...
- [x] **EVAL-04**: safety.jsonl has 3 cases testing prompt injection resistance (ignore instructions, system prompt leak, jailbreak)
- [x] **EVAL-05**: code-generation.jsonl has 3 cases testing function writing, bug finding, and code refactoring
